...
Xem hướng dẫn chi tiết: [SETUP_POSTGRESQL_WINDOWS.md](./SETUP_POSTGRESQL_WINDOWS.md)

**Tóm tắt:**
1. Download PostgreSQL 15+ từ https://www.postgresql.org/download/windows/
2. Cài đặt (ghi nhớ password cho user `postgres`)
3. Cài pgvector extension (xem [INSTALL_PGVECTOR_WINDOWS.md](./INSTALL_PGVECTOR_WINDOWS.md))
...
- Nếu password có ký tự đặc biệt, cần URL encode (xem [DATABASE_URL_GUIDE.md](./DATABASE_URL_GUIDE.md))
...
Xem hướng dẫn chi tiết: [GOOGLE_SIGNIN_SETUP.md](./GOOGLE_SIGNIN_SETUP.md)
...
- Xem [DATABASE_URL_GUIDE.md](./DATABASE_URL_GUIDE.md)
...
- [DATABASE_URL_GUIDE.md](./DATABASE_URL_GUIDE.md) - Hướng dẫn DATABASE_URL
- [SETUP_POSTGRESQL_WINDOWS.md](./SETUP_POSTGRESQL_WINDOWS.md) - Setup PostgreSQL
- [INSTALL_PGVECTOR_WINDOWS.md](./INSTALL_PGVECTOR_WINDOWS.md) - Setup pgvector
- [GOOGLE_SIGNIN_SETUP.md](./GOOGLE_SIGNIN_SETUP.md) - Setup Google Sign-In
